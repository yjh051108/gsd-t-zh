...
const I18N = {
  "en": {},
  "zh-CN": {
    "Installing GSD-T": "正在安装 GSD-T",
    "Updating GSD-T": "正在更新 GSD-T",
    "Created ~\.claude\/commands\/": "已创建 ~\/.claude\/commands\/",
    "commands installed": "个命令已安装",
    "global bin tool": "个全局 bin 工具",
    "Missing global bin tool in ~\/.claude\/bin\/": "~\/.claude\/bin\/ 中缺少全局 bin 工具:",
    "Fix: re-run `npx @tekyzinc\/gsd-t install` (or `update`)": "修复: 重新运行 `npx @tekyzinc\/gsd-t install` (或 `update`)",
    "No GSD-T commands installed": "未安装 GSD-T 命令",
    "No global CLAUDE.md": "无全局 CLAUDE.md",
    "CLAUDE.md contains GSD-T config": "CLAUDE.md 包含 GSD-T 配置",
    "CLAUDE.md exists but missing GSD-T section": "CLAUDE.md 存在但缺少 GSD-T 配置段",
    "GSD-T Status": "GSD-T 状态",
    "Slash Commands": "斜杠命令",
    "Global Config": "全局配置",
    "Agent Teams": "代理团队",
    "Context Meter": "上下文仪表盘",
    "Current Project": "当前项目",
    "Other commands:": "其他命令:",
    "Update All Complete": "全部更新完成",
    "Installed version:": "已安装版本:",
    "Commands installed": "个命令已安装",
    "Custom commands found:": "发现自定义命令:",
    "Project registered:": "已注册项目:",
    "Updated:": "已更新:",
    "Already current:": "已是最新:",
    "Not found:": "未找到:",
    "Errors:": "错误:",
    "Missing Playwright:": "缺少 Playwright:",
    "Auto-installed Playwright in:": "已自动安装 Playwright 到:",
    "Missing Swagger:": "缺少 Swagger:",
    "Global rules synced:": "已同步全局规则:",
    "All projects have Playwright and Swagger configured": "所有项目已配置 Playwright 和 Swagger",
    "No settings.json found (Claude Code will use defaults)": "未找到 settings.json (Claude Code 将使用默认值)",
    "Heartbeat (Real-time Events)": "心跳 (实时事件)",
    "Global CLAUDE.md": "全局 CLAUDE.md",
    "Bin tool:": "Bin 工具:",
    "templates installed": "个模板已安装",
    "Commands:": "命令:",
    "Context:": "上下文:",
    "Token Usage by Domain": "按领域的 Token 使用",
    "Token Usage by Command": "按命令的 Token 使用",
    "Process Health:": "流程健康:",
    "Graph:": "代码图:",
    "Flagged Components:": "标记的组件:",
    "No flagged components": "无标记组件",
    "No global metrics yet": "暂无全局指标",
    "Global ELO:": "全局 ELO:",
    "Cross-Project Rankings (Top 5)": "跨项目排名 (前 5)",
    "Rank": "排名",
    "Project": "项目",
    "ELO": "ELO",
    "Latest Milestone": "最近里程碑",
    "install": "安装",
    "update": "更新",
    "update-all": "全部更新",
    "init": "初始化",
    ...
    "Locale: en": "Locale: en",
    "CLAUDE.md installed": "CLAUDE.md 已安装",
    "Global bin tools installed": "全局 bin 工具已安装",
    "Project initialized with GSD-T workflow": "项目已使用 GSD-T 工作流初始化",
    "Headless runs since you left": "自您离开以来的无头运行",
    "Backlog:": "待办列表:",
    "Backlog: No items": "待办列表: 无条目",
    "Next action:": "下一步:",
    "Next checkpoint:": "下一个检查点:",
    "Domains:": "领域:",
    "Recent decisions:": "最近的决策:",
    "Model Profile:": "模型配置文件:",
    "Phase:": "阶段:",
    "Blockers": "阻塞项",
    "Session Log": "会话日志",
    ...
    "and": "和",
    "Changelog:": "变更日志:",
    "https:\/\/github.com\/Tekyz-Inc\/get-stuff-done-teams\/blob\/main\/CHANGELOG.md": "https:\/\/github.com\/Tekyz-Inc\/get-stuff-done-teams\/blob\/main\/CHANGELOG.md",
    "Config:": "配置:",
    "Hooks:": "钩子:",
    "Teams:": "团队:",
    "Projects:": "项目:",
    ...
    "Array.prototype.splice": "拼接",
    "Array.prototype.push": "推送",
    "Array.prototype.pop": "弹出",
    "Array.prototype.shift": "移位",
    "Array.prototype.unshift": "取消移位",
    "Array.prototype.map": "映射",
    "Array.prototype.filter": "过滤",
    "Array.prototype.reduce": "归约",
    "Array.prototype.reduceRight": "从右归约",
    "Array.prototype.find": "查找",
    "Array.prototype.findIndex": "查找索引",
    "Array.prototype.some": "某些",
    "Array.prototype.every": "每个",
    "Array.prototype.includes": "包含",
    "Array.prototype.indexOf": "索引",
    "Array.prototype.lastIndexOf": "最后索引",
    "Array.prototype.join": "连接",
    "Array.prototype.reverse": "反转",
    "Array.prototype.sort": "排序",
    "Array.prototype.fill": "填充",
    "Array.prototype.copyWithin": "内部复制",
    "Array.prototype.entries": "条目",
    "Array.prototype.keys": "键",
    "Array.prototype.values": "值",
    "Array.prototype.forEach": "遍历",
    "Array.prototype.flat": "扁平化",
    "Array.prototype.flatMap": "扁平映射",
    "String": "字符串",
    "String.prototype": "字符串原型",
    "String.prototype.trim": "修剪",
    "String.prototype.trimStart": "修剪开始",
    "String.prototype.trimEnd": "修剪结束",
    "String.prototype.padStart": "填充开始",
    "String.prototype.padEnd": "填充结束",
    "String.prototype.repeat": "重复",
    "String.prototype.replace": "替换",
    "String.prototype.replaceAll": "全部替换",
    "String.prototype.split": "分割",
    "String.prototype.slice": "切片",
    "String.prototype.substring": "子串",
    "String.prototype.substr": "子串",
    "String.prototype.indexOf": "索引",
    "String.prototype.lastIndexOf": "最后索引",
    "String.prototype.search": "搜索",
    "String.prototype.match": "匹配",
    "String.prototype.matchAll": "全部匹配",
    "String.prototype.charAt": "字符",
    "String.prototype.charCodeAt": "字符编码",
    "String.prototype.codePointAt": "码点",
    "String.prototype.includes": "包含",
    "String.prototype.startsWith": "以...开始",
    "String.prototype.endsWith": "以...结束",
    "String.prototype.localeCompare": "区域比较",
    "String.prototype.normalize": "规范化",
    "String.prototype.toUpperCase": "大写",
    "String.prototype.toLowerCase": "小写",
    "String.prototype.toString": "字符串",
    "String.prototype.valueOf": "值",
    "String.prototype.localeUpperCase": "区域大写",
    "String.prototype.localeLowerCase": "区域小写",
    "Number": "数字",
    "Number.prototype": "数字原型",
    "Number.prototype.toString": "字符串",
    "Number.prototype.toFixed": "固定位数",
    "Number.prototype.toExponential": "指数",
    ...
    "Function.prototype.apply": "应用",
    "Function.prototype.bind": "绑定",
    "Function.prototype.toString": "字符串",
    "RegExp": "正则",
    "RegExp.prototype": "正则原型",
    "RegExp.prototype.test": "测试",
    "RegExp.prototype.exec": "执行",
    "RegExp.prototype.toString": "字符串",
    "Error": "错误",
    "Error.prototype": "错误原型",
    "Error.prototype.toString": "字符串",
    "EvalError": "求值错误",
    "RangeError": "范围错误",
    "ReferenceError": "引用错误",
    "SyntaxError": "语法错误",
    ...
    "AggregateError": "聚合错误",
    "Promise": "承诺",
    "Promise.prototype": "承诺原型",
    "Promise.prototype.then": "然后",
    "Promise.prototype.catch": "捕获",
    "Promise.prototype.finally": "最终",
    "Promise.resolve": "解决",
    "Promise.reject": "拒绝",
    "Promise.all": "全部",
    "Promise.allSettled": "全部已决",
    "Promise.race": "竞赛",
    "Promise.any": "任一",
    "setTimeout": "超时设置",
    "setInterval": "间隔设置",
    ...
    "process.execArgv": "执行参数",
    "process.argv0": "参数0",
    "process.title": "标题",
    "process.env": "环境",
    "process.mainModule": "主模块",
    "process.moduleLoadList": "模块加载列表",
    "process._exiting": "退出中",
    "process._events": "事件",
    "process._eventsCount": "事件计数",
    "process._maxListeners": "最大监听器",
    "process._fatalException": "致命异常",
    "process._getActiveHandles": "获取活跃句柄",
    "process._getActiveRequests": "获取活跃请求",
    "process._kill": "终止",
    "process._send": "发送",
    "process._debugProcess": "调试进程",
    "global": "全局",
    "globalThis": "全局",
    "window": "窗口",
    "self": "自身",
    ...
    "shadow": "影子",
    "delegates-focus": "委托焦点",
    "slot": "插槽",
    "template": "模板",
    "content": "内容",
    "shadowroot": "影子根",
    "shadowrootmode": "影子根模式",
    "part": "部分",
    "exportparts": "导出部分",
    "aria-atomic": "原子",
    "aria-busy": "忙碌",
    ...
    "aria-details": "详情",
    "aria-disabled": "禁用",
    "aria-dropeffect": "投放效果",
    "aria-errormessage": "错误消息",
    "aria-flowto": "流至",
    "aria-grabbed": "抓取",
    "aria-haspopup": "有弹出",
    "aria-hidden": "隐藏",
    "aria-invalid": "无效",
    "aria-keyshortcuts": "快捷键",
    "aria-label": "标签",
    "aria-labelledby": "标记",
    "aria-live": "实时",
    "aria-owns": "拥有",
    "aria-relevant": "相关",
    "aria-roledescription": "角色描述",
    "aria-expanded": "展开",
    "aria-haspopup": "有弹出",
    "aria-pressed": "按下",
    "aria-selected": "选中",
    ...
    "role-menubar": "菜单栏",
    "role-menuitem": "菜单项",
    "role-menuitemcheckbox": "菜单复选框",
    "role-menuitemradio": "菜单单选",
    "role-navigation": "导航",
    "role-note": "备注",
    "role-option": "选项",
    "role-presentation": "呈现",
...
function getLocale() {
  const envLocale = process.env.GSD_T_LOCALE;
  if (envLocale === "zh-CN" || envLocale === "zh") return "zh-CN";
  try {
    if (fs.existsSync(SETTINGS_JSON)) {
      const settings = JSON.parse(fs.readFileSync(SETTINGS_JSON, "utf8"));
      const sl = (settings.env && settings.env.GSD_T_LOCALE) || "";
      if (sl === "zh-CN" || sl === "zh") return "zh-CN";
    }
  } catch (_) {}
  return "en";
}
...
function getInstalledCommands() {
  try {
    const ourCommands = getCommandFiles().map((f) => f.replace(/\.zh-CN\.md$/, ".md"));
    return fs
